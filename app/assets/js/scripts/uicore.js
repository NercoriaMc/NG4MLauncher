        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/NercoriaMc/NG4MLauncher/releases/download/v${info.version}/NextGen4Minecraft-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : ''}.dmg`
                    showUpdateUI(info)
                }
            ...
            case 'update-downloaded':
                loggerAutoUpdaterSuccess.log('Mise a jour ' + info.version + ' prêt à être installé.')
